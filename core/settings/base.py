...
MEDIA_ROOT = Path(_media_root) if str(_media_root).strip() else BASE_DIR / "media"
...
CLOUDINARY_FOLDER = env("CLOUDINARY_FOLDER", default="dts")

STORAGES = {
    "default": {
        "BACKEND": "core.storage.DjangoMediaStorage",
    },
    "staticfiles": {
